...
def HomeView(request):
    items =  Items.objects.all() #यह सभी Items मॉडल के ऑब्जेक्ट्स को प्राप्त करता है।
    list = ItemList.objects.all() #यह सभी ItemList मॉडल के ऑब्जेक्ट्स को प्राप्त करता है।
    review = Feedback.objects.all() #यह सभी Feedback  मॉडल के ऑब्जेक्ट्स को प्राप्त करता है। 
